...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            WebDriverWait wait = new WebDriverWait(driver,30);
            // wait.until(ExpectedConditions.textToBePresentInElementLocated(By.xpath("//div[@class='MuiCardContent-root css-1qw96cp']/p[text()='YONEX Smash Badminton Racquet']")));
    ...
    public Boolean verifyCartContents(List<String> expectedCartContents) {
        try {
            ...
            for (WebElement cartItem : cartContents) {
                actualCartContents.add(cartItem.findElement(By.xpath("//div[@class='MuiBox-root css-zgtx0t']/div[2][@class='MuiBox-root css-1gjj37g']")).getText().split("\n")[0]);
            }
